...
my 	$TrackName			= $UCSCDir;
	$TrackName			=~ s/^\/home\/pholmgren\/www\/UCSC\///g;
	$TrackName			=~ s/\/$//g;
my 	$BaiPath			= $BamPath;
	$BaiPath			=~ s/\.bam/\.bai/g;
...
### Copy ###
					 ...
					 system ("cp $BamPath /home/pholmgren/www/UCSC/$TrackName\/");	
if (-f $BaiPath)	{system ("cp $BaiPath /home/pholmgren/www/UCSC/$TrackName\/");	}
...
my 	$SortedBam = "/home/pholmgren/www/UCSC/$TrackName\/$BamFileName";
	
if ($Sorted eq "no"){
	
	$SortedBam =~ s/\.bam/\.sorted/g;
	
	system ("./samtools sort /home/pholmgren/www/UCSC/$TrackName\/$BamFileName -o $SortedBam");
}
